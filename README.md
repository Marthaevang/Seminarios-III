...
<li> Etapa 4: <a href="docs/5-Arquitetura da Solução.md"> Arquitetura da Solução</a></li>
<li> Etapa 4: <a href="docs/6-Template padrão do Site.md"> Template padrão do Site</a></li>
<li> Etapa 4: <a href="docs/7-Programação de Funcionalidades.md"> Programação de Funcionalidades</a></li>
<li> Etapa 4: <a href="docs/8-Plano de Testes de Software.md"> Plano de Testes de Software</a></li>
